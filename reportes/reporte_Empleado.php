...
// Cadena de conexión
$con = mysqli_connect("localhost","root","","developerweb");
...
while($row = mysqli_fetch_array($result)){ 
    ...
    $pdf->Cell(50,5, utf8_decode($row[2]),1,0,'C');
    $pdf->Cell(20,5, utf8_decode($row[3]),1,0,'C');
    $pdf->Cell(100,5, utf8_decode($row[4]),1,0,'C');
    $pdf->Cell(20,5, utf8_decode($row[5]),1,0,'C');
}
