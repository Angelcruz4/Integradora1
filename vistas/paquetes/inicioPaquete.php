    ...
    <tbody>
        <?php while($row = mysqli_fetch_assoc($resultado)):?>
            <tr>
                ...
                <td><center><a class="btn btn-success btn-sm" href=?cargar=editarPaquete&id_paquete=<?php echo $row['id_paquete'] ?>><i class="fas fa-edit"></i></center></a></td>
                <td><center><a class="btn btn-danger btn-sm" onClick='confirmar(<?php echo $row['id_paquete']; ?> )'style="cursor: pointer;"><i class="fas fa-trash-alt"></i></center></a></td>
